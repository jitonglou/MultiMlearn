...
The coding example for subgroup identification can be found at [this GitHub repository](https://github.com/jitonglou/EHR_ITR), while it is not a function of the `MultiMlearn` package.
