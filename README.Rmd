...
## Vignette
An implementation of the `MultiMlearn` package to a simulated dataset can refer to [this R Markdown file](https://github.com/jitonglou/MultiMlearn/blob/master/doc/example.Rmd) and [this html file](https://github.com/jitonglou/MultiMlearn/blob/master/doc/example.html). Details of the simulation study can be found in Section S.1 of [this pdf document](https://github.com/jitonglou/MultiMlearn/blob/master/doc/supp_v3.pdf).  
